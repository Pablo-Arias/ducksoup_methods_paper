...
#Import data
file_name = "data/semantics_for_glmm.csv"
...
#defining outcomes
measure			          <-as.numeric(data$gpt_rating)
...
transcription_quality		<- as.numeric(data$transcription_quality)


#create new dataframe
all_data=data.frame( measure, participant_condition , interacting_partner, other_condition, participant_nb, question_content, transcription_quality )
